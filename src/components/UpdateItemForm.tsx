...
export default function UpdateItemForm({
  ...
  const [imagePreview, setImagePreview] = useState<string | null>(itemImage || null)
  ...
  const currentPriceInCents = Math.round(parseFloat(String(formData.priceInCents)) * 100)
  const isModified =
  ...
  function handleSubmit(e: FormEvent<HTMLFormElement>) {
    ...
    data.append("priceInCents", String(Math.round(parseFloat(String(formData.priceInCents)) * 100)))
